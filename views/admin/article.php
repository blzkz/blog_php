	<div class='grid_9'>
		<form action="<?php echo base_url().'admin/control';?>" method="post">
			<div class='container_12'>
				...
				<div class='grid_10'><input name="title" id='title' type="text"></div>
			</div>
			<div class='container_12'>
				<div class='grid_2' style='text-align:right'><label for='url'>Image url: </label></div>
				<div class='grid_10'><input name="url" id='url' type="text"></div>
			</div>
			<div class='container_12'>
				<div class='grid_2' style='text-align:right'><label for='password'>Content: </label></div>
				<div class='grid_10'><textarea name="content" id="content"></textarea></div>
			</div>
